      ...
      <div class="container hv_3kp_item">
        ...
        <?php
                      ...
                      if($data_IDB !='') {
                         ...
                         $sql = "insert into 3kp(stt,name,privKey,pubKey) values('','acquirer','".$privKey_acquire."','".$pubKey_acquire."')";
                          $query = mysqli_query($conn,$sql);
                           ...
                           $res = openssl_public_encrypt($dataa, $IDB_encrypt, $pubKey_acquirer,OPENSSL_PKCS1_PADDING);
          ...
          <div class="col-md-12 form-group">
              <div class="col-md-6 hv_item_td" style= "padding-right:15px">
              ...
              <div class="col-md-6 hv_item_td" style= "padding-left:15px">
