		...
		<div class="container">
			...
			<div class="row ">
				<div class="col-md-6 col-md-offset-4 buyer">
					<form action="./1KP/merchant.php" class="form-group " method="post">
					<h1 class='hv_td'>Nhập tên giả</h1>
					<input type="text" name="name_fake" value="" placeholder="" class="form-control form-group hv_box_mess">
					<h1 class='hv_td'>Nhập thông điệp của Buyer</h1>
