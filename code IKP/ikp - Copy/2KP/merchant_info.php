...
<body>
	<div class="hv_dad hv_dad_2kp">
		...
		<div class="container">
			...
			<div class="row hv_merchant_in4_2kp">
			...
			<div class="row">
				<form action="" method="post" class="form-group">
					<div class="col-md-6 form-group">
						...
						<input type="text" name="messages_merchant" value="<?php if(isset($_POST['messages_merchant'])) echo $_POST['messages_merchant']; ?>" class="form-control hv_box_mess">
						
					</div>
					<div class="col-md-12">
						<button type="submit" name="sign_merchant" style="margin-top:0"  class="form-group hv_btn_sent"><span>Ký lên văn bản</span></button>
					</div>
				...
				<?php if(isset($_POST['sign_merchant'])) {
		            ...
		            $sql = "select * from 2KP where name='merchant'";
