		...
		echo '</pre>';
		 ...
		 <div class="col-md-12">
			...
			<div class="col-md-6 hv_check_ac3kp" style='positon:relative'>
						...
						if ($pubKey_acquire === FALSE){return false;}
							...
							if (isset($data)) {
								...
								if ($data1 === $check_sign_merchant && $data1 === $check_sign_buyer) {
									...
									openssl_private_decrypt($data,$check_idb_data,$privKey_acquire);

																	
									if( $check_idb_merchant === $check_idb_data && $check_idb_data === $check_idb_buyer ){
				...
				?>
				<button type="submit" name="check_acquirer"  class="form-group hv_btn_sent"><span>Kiểm tra</span></button>
			</div>
